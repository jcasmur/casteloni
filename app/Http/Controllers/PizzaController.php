...
class PizzaController extends Controller
{
    ...
    public function update(PizzaUpdateRequest $request, $id)
    {
        ...
        return redirect()->route('pizza.index')->with('message', 'Pizza actualizada correctamente!');
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('pizza.index')->with('message', 'Pizza eliminada correctamente!');
    }
}
